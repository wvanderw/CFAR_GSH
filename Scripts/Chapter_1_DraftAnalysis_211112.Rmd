...
```{r}
##Install packages
#install.packages(c('ape','phytools','nlme','tidyverse','gieger','xlsx','here','readxl','brms','rstan','gdata','bayesplot','StanHeaders'))
...
z <- GSH_df_pgls$Log10MaxSize_centered 
N <- length(GSH_df_pgls$Binomial)

stan_data <- list(N = N, x = x, y = y, z = z)
