...
knitr::opts_knit$set(root.dir = '~/Desktop/Dulvy Lab/Thesis/Chapter 1 - GSH & Activity Level/CFAR_GSH')
```
...
fit1 <- stan(file = './Scripts/StanModel1.stan', data = stan_data, warmup = 500, iter = 1000, chains = 4, cores = 2, thin = 1)
