...
for (i in 1:500) {
 abline(posterior3[i,1], posterior3[i,2], col = adjustcolor("gray", alpha = 0.05), lty = 1)
}
...
abline(mean(posterior6[,1]), mean(posterior6[,2]), col = 'green', lw = 2)


abline(a = coef(pglsMod5)[1], b = coef(pglsMod5)[2], col = 2, lty = 2, lw = 5)
```
