...
pca_vals <- prcomp(GSH_PCA[,c(18,19,26,27,34,39)], center = T, scale = T)
...
pca_load <- as_tibble(pca_vals$rotation, rownames = 'variable') %>% 
  mutate(variable = dplyr::recode(variable, 
                                  ...
                                  'MaxLinearDimension' = 'Max Size',
                                  'MedianDepth_m' = 'Depth'))
head(pca_load)


pca_load_labels <- pca_load %>% 
  transmute(variable, PC1 = PC1*7, PC2 = PC2*7)

pca_load_labels[1,3] <- pca_load_labels[1,3]+0
pca_load_labels[2,3] <- pca_load_labels[2,3]-0.25
pca_load_labels[3,3] <- pca_load_labels[3,3]-0.05
pca_load_labels[4,3] <- pca_load_labels[4,3]+0.25
pca_load_labels[5,3] <- pca_load_labels[5,3]+0.35
pca_load_labels[6,3] <- pca_load_labels[6,3]-1.5
