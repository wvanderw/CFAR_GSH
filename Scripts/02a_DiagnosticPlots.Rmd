...
I_C <- ggplot(out_IC, aes(x = x, y = y)) +
  ...
  geom_vline(xintercept = brms_4_CI$CI_low[1], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_4_CI$CI_high[1], color = '#1b9e77', size = 1, alpha = 0.3) +
  xlim(-1.75, 1.75) +
  ylab(element_blank()) +
  xlab(element_blank()) +
  theme_bw() +
...
S_G <- ggplot(out_SG, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_4_CI$CI_low[2], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_4_CI$CI_high[2], color = '#1b9e77', size = 1, alpha = 0.3) +
...
S_S <- ggplot(out_SS, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_4_CI$CI_low[3], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_4_CI$CI_high[3], color = '#1b9e77', size = 1, alpha = 0.3) +
    geom_vline(xintercept = 0, lty = 2) +
  xlim(-1.75, 1.75) +
  ylab(element_blank()) +
  xlab(element_blank()) +
...
S_D <- ggplot(out_SD, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_4_CI$CI_low[4], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_4_CI$CI_high[4], color = '#1b9e77', size = 1, alpha = 0.3) +
    geom_vline(xintercept = 0, lty = 2) +
  xlim(-1.75, 1.75) +
  ylab(element_blank()) +
  xlab(element_blank()) +
...
SIG <- ggplot(out_sigma, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_4_CI$CI_low[5], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_4_CI$CI_high[5], color = '#1b9e77', size = 1, alpha = 0.3) +
    geom_vline(xintercept = 0, lty = 2) +
  xlim(-1.75, 1.75) +
  ylab(element_blank()) +
  xlab(element_blank()) +
...
panel_plot <- I_C + S_G + S_S + S_D + SIG + plot_layout(ncol = 1)
