...
#coastal
  for (i in 1:500) {
 plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_13, summary = F)[i,1], slope = fixef(brms_13, summary = F)[i,2], color = adjustcolor("#d95f02", alpha = 0.05), lty = 1) 
} 

#deepwater
  for (i in 501:1000) {
 plot_11 <- plot_11 + geom_abline(intercept = (fixef(brms_13, summary = F)[i,1]+fixef(brms_13, summary = F)[i,3]), slope = fixef(brms_13, summary = F)[i,2], color = adjustcolor("#7570b3", alpha = 0.05), lty = 1) 
} 

#pelagic
  for (i in 1001:1500) {
 plot_11 <- plot_11 + geom_abline(intercept = (fixef(brms_13, summary = F)[i,1]+fixef(brms_13, summary = F)[i,4]), slope = fixef(brms_13, summary = F)[i,2], color = adjustcolor("#1b9e77", alpha = 0.05), lty = 1) 
} 

#coastal
plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_13)[1,1], slope = fixef(brms_13)[2,1], color = '#d95f02', size = 1.5)
#deepwater
plot_11 <- plot_11 + geom_abline(intercept = (fixef(brms_13)[1,1]+fixef(brms_13)[3,1]), slope = fixef(brms_13)[2,1], color = '#7570b3', size = 1.5)
#pelagic
plot_11 <- plot_11 + geom_abline(intercept = (fixef(brms_13)[1,1]+fixef(brms_13)[4,1]), slope = fixef(brms_13)[2,1], color = '#1b9e77', size = 1.5)
...
ggsave(here('./Data/Output/Model9_plot.png'), plot_11, height = 20, width = 30, units = 'cm')
...
brms_9_CI <- ci(brms_13, method = "HDI", component = 'all')

brms_9_CI$CI_low[1]


out <- estimate_density(brms_9_post, extend = T, select = 'b_Intercept')

#intercept - coastal
out_IC <- estimate_density(brms_9_post, extend = T, select = 'b_Intercept')

I_C <- ggplot(out_IC, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_13_CI$CI_low[1], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_13_CI$CI_high[1], color = '#1b9e77', size = 1, alpha = 0.3) +
  xlim(-1, 1) +
  ylim(0,22) +
  ylab(element_blank()) +
  xlab(element_blank()) +
...
#intercept - deepwater
out_ID <- estimate_density(brms_13_post, extend = T, select = 'b_PrimaryHabitat2')

out_ID$x <- out_ID$x + fixef(brms_13)[1,1]

I_D <- ggplot(out_ID, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_13_CI$CI_low[3]+fixef(brms_13)[1,1], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_13_CI$CI_high[3]+fixef(brms_13)[1,1], color = '#1b9e77', size = 1, alpha = 0.3) +
  xlim(-1, 1) +
  ylim(0,22) +
  ylab(element_blank()) +
  xlab(element_blank()) +
...
I_D
#intercept - pelagic
out_IP <- estimate_density(brms_13_post, extend = T, select = 'b_PrimaryHabitat3')

out_IP$x <- out_IP$x + fixef(brms_13)[1,1]

I_P <- ggplot(out_IP, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_13_CI$CI_low[4]+fixef(brms_13)[1,1], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_13_CI$CI_high[4]+fixef(brms_13)[1,1], color = '#1b9e77', size = 1, alpha = 0.3) +
  xlim(-1, 1) +
  ylim(0,22) +
  ylab(element_blank()) +
  xlab(element_blank()) +
...
I_P
#slope - CFAR ~ GSH
out_SG <- estimate_density(brms_13_post, extend = T, select = 'b_Log10CFAR_centered')

S_G <- ggplot(out_SG, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_13_CI$CI_low[2], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_13_CI$CI_high[2], color = '#1b9e77', size = 1, alpha = 0.3) +
...
S_G
#slope - CFAR ~ Size
out_SS <- estimate_density(brms_13_post, extend = T, select = 'b_Log10MaxSize_centered')

S_S <- ggplot(out_SS, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_13_CI$CI_low[5], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_13_CI$CI_high[5], color = '#1b9e77', size = 1, alpha = 0.3) +
    geom_vline(xintercept = 0, lty = 2) +
  xlim(-1, 1) +
  ylim(0,50) +
  ylab(element_blank()) +
...
#sigma
out_sigma <- estimate_density(brms_13_post, extend = T, select = 'sigma')


SIG <- ggplot(out_sigma, aes(x = x, y = y)) +
  geom_area(fill = '#7570b3')+
  geom_vline(xintercept = brms_13_CI$CI_low[6], color = '#1b9e77', size = 1, alpha = 0.3)+
  geom_vline(xintercept = brms_13_CI$CI_high[6], color = '#1b9e77', size = 1, alpha = 0.3) +
    geom_vline(xintercept = 0, lty = 2) +
...
panel_plot <- I_C + I_D + I_P + S_G + S_S + SIG + plot_layout(ncol = 1)
...
ggsave(here('./Data/Output/panel_plot.png'), panel_plot, height = 20, width = 35, units = 'cm')
