...
I_C <- ggplot(out_IC, aes(x = x, y = y)) +
  geom_area(fill = 'red')+
  geom_vline(xintercept = brms_11_CI$CI_low[1], color = 'royalblue', size = 3)+
  geom_vline(xintercept = brms_11_CI$CI_high[1], color = 'royalblue', size = 3)
...
I_D <- ggplot(out_ID, aes(x = x, y = y)) +
  geom_area(fill = 'red')+
  geom_vline(xintercept = brms_11_CI$CI_low[4], color = 'royalblue', size = 3)+
  geom_vline(xintercept = brms_11_CI$CI_high[4], color = 'royalblue', size = 3)
...
I_P <- ggplot(out_IP, aes(x = x, y = y)) +
  geom_area(fill = 'red')+
  geom_vline(xintercept = brms_11_CI$CI_low[5], color = 'royalblue', size = 3)+
  geom_vline(xintercept = brms_11_CI$CI_high[5], color = 'royalblue', size = 3)
...
S_G <- ggplot(out_SG, aes(x = x, y = y)) +
  geom_area(fill = 'red')+
  geom_vline(xintercept = brms_11_CI$CI_low[2], color = 'royalblue', size = 3)+
  geom_vline(xintercept = brms_11_CI$CI_high[2], color = 'royalblue', size = 3)
...
S_S <- ggplot(out_SS, aes(x = x, y = y)) +
  geom_area(fill = 'red')+
  geom_vline(xintercept = brms_11_CI$CI_low[3], color = 'royalblue', size = 3)+
  geom_vline(xintercept = brms_11_CI$CI_high[3], color = 'royalblue', size = 3)
...
Int_GS <- ggplot(out_GS, aes(x = x, y = y)) +
  geom_area(fill = 'red')+
  geom_vline(xintercept = brms_11_CI$CI_low[6], color = 'royalblue', size = 3)+
  geom_vline(xintercept = brms_11_CI$CI_high[6], color = 'royalblue', size = 3)
...
SIG <- ggplot(out_sigma, aes(x = x, y = y)) +
  geom_area(fill = 'red')+
  geom_vline(xintercept = brms_11_CI$CI_low[7], color = 'royalblue', size = 3)+
  geom_vline(xintercept = brms_11_CI$CI_high[7], color = 'royalblue', size = 3)
