...
size.func <- function(x){
  (sd(GSH_df_full$LogMaxSize, na.rm = T)*x) + mean(GSH_df_full$LogMaxSize, na.rm = T)
}
...
for(i in -2:1){
  depth.labels[i +3] <- (sd(GSH_df_full$LogDepthMedian, na.rm = T)*i) + mean(GSH_df_full$LogDepthMedian, na.rm = T)
}
...
plot_11 <- ggplot(aes(x = LogCFAR_centered, y = LogMeanGSH_centered,  colour = LogDepthMedian_centered), data = GSH_df_full) + geom_point(alpha = 0.5, aes(size = LogMaxSize_centered)) +
  scale_size(guide = "legend", breaks = c(-2, 0, 2, 4), labels = size.labels, name = "Log Max Size") +
  scale_color_gradient(low = '#D1D5FF', high = '#070469', name = "Log Median Depth", breaks = c(-2, -1, 0, 1), labels = depth.labels)+
  theme_bw()+
...
x.ticks <- rep(NA, 5)
for(i in -2:2){
x.ticks[i+3] <- (sd(GSH_df_full$LogCFAR)*i) + mean(GSH_df_full$LogCFAR)
}

y.ticks <- rep(NA, 5)
for(i in -2:2){
  y.ticks[i+3] <- (sd(GSH_df_full$LogMeanGSH)*i) + mean(GSH_df_full$LogMeanGSH)
}
...
plot_11 <- plot_11 +
  scale_x_continuous(name = "Log CFAR", breaks = c(-2,-1,0,1,2), labels = as.character(x.ticks)) +
  scale_y_continuous(name = "Log Mean GSH (proportion of TL)", breaks = c(-2,-1,0,1,2), labels = y.ticks)
...
I_C <- ggplot(out_IC, aes(x = x, y = y)) +
  geom_segment(x = brms_4_CI$CI_low[1], xend = brms_4_CI$CI_high[1], y = 1.25, yend = 1.25, color = 'black', size = 1, alpha = 0.3)+
  geom_point(x = mean(brms_4_post$b_Intercept), y = 1.25, size = 2,  color = 'black') +
  geom_vline(xintercept = 0, lty = 2) +
  xlim(-1, 1.25) +
  ylim(0,2) +
  annotate("text", x = 1.25, y = 1, label = "Intercept") +
...
S_G <- ggplot(out_SG, aes(x = x, y = y)) +
  geom_segment(x = brms_4_CI$CI_low[2], xend = brms_4_CI$CI_high[2], y = 1.25, yend = 1.25, color = 'black', size = 1, alpha = 0.3)+
  geom_point(x = mean(brms_4_post$b_LogCFAR_centered), y = 1.25,  color = 'black', size = 2) +
  geom_vline(xintercept = 0, lty = 2) +
  xlim(-1, 1.25) +
  ylim(0,2) +
  annotate("text", x = 1.25, y = 1, label = "Activity") +
  theme(legend.position = "none",
        panel.grid = element_blank(),
        axis.title = element_blank(),
        axis.text = element_blank(),
...
S_S <- ggplot(out_SS, aes(x = x, y = y)) +
  geom_segment(x = brms_4_CI$CI_low[3], xend = brms_4_CI$CI_high[3], y = 1.25, yend = 1.25, color = 'black', size = 1, alpha = 0.3) +
  geom_point(x = mean(brms_4_post$b_LogMaxSize_centered), y = 1.25, color = 'black', size = 2) +
    geom_vline(xintercept = 0, lty = 2) +
  xlim(-1, 1.25) +
  ylim(0,2) +
  annotate("text", x = 1.25, y = 1, label = "Max size") +
  theme(legend.position = "none",
        panel.grid = element_blank(),
        axis.title = element_blank(),
        axis.text = element_blank(),
...
LEG.df <- data.frame(x = c(rep(-1,4)), y = c(0.625, 0.875, 1.125, 1.375), size = 2, shape = c(23, 15, 17, 16), color = c('grey60','grey60','grey60', 'black'))
...
LEG <- LEG +
  annotate("text", x = -0.75, y = 1.75, label = "Model", size = 4) +
  annotate("text", x = -0.75, y = 1.375, label = "Ecological lifestyle", size = 3) +
  annotate("text", x = -0.75, y = 1.125, label = "Activity", size = 3) +
  annotate("text", x = -0.75, y = 0.875, label = "Size", size = 3) +
  annotate("text", x = -0.75, y = 0.625, label = "Depth", size = 3)
...
S_D <- ggplot(out_SD, aes(x = x, y = y)) +
 geom_segment(x = brms_4_CI$CI_low[4], xend = brms_4_CI$CI_high[4], y = 1.25, yend = 1.25, color = 'black', size = 1, alpha = 0.3) +
  geom_point(x = mean(brms_4_post$b_LogDepthMedian_centered), y = 1.25, color = 'black', size = 2) +
    geom_vline(xintercept = 0, lty = 2) +
  xlim(-1, 1.25) +
  ylim(0,2) +
  annotate("text", x = 1.25, y = 1, label = "Depth") +
 theme(legend.position = "none",
        panel.grid = element_blank(),
        axis.title = element_blank(),
        axis.text = element_blank(),
...
SIG <- ggplot(out_sigma, aes(x = x, y = y)) +
  geom_segment(x = brms_4_CI$CI_low[5], xend = brms_4_CI$CI_high[5], y = 1.25, yend = 1.25, color = 'black', size = 1, alpha = 0.3) +
  ...
  ylim(0,2) +
  annotate("text", x = 1.25, y = 1, label = "Sigma") +
  theme(legend.position = "none",
        panel.grid = element_blank(),
        axis.title.y = element_blank(),
...
I_C1 <- ggplot(out_IC1, aes(x = x, y = y)) +
  geom_segment(x = brms_1_CI$CI_low[1], xend = brms_1_CI$CI_high[1], y = 1, yend = 1, color = 'grey60', size = 1, alpha = 0.5)+
...
S_G1 <- ggplot(out_SG1, aes(x = x, y = y)) +
  geom_segment(x = brms_1_CI$CI_low[2], xend = brms_1_CI$CI_high[2], y = 1, yend = 1, color = 'grey60', size = 1, alpha = 0.3)+
...
SIG1 <- ggplot(out_sigma1, aes(x = x, y = y)) +
  geom_segment(x = brms_1_CI$CI_low[3], xend = brms_1_CI$CI_high[3], y = 1, yend = 1, color = 'grey60', size = 1, alpha = 0.3)+
...
I_C2 <- ggplot(out_IC2, aes(x = x, y = y)) +
  geom_segment(x = brms_2_CI$CI_low[1], xend = brms_2_CI$CI_high[1], y = 0.8, yend = 0.8, color = 'grey60', size = 1, alpha = 0.3)+
...
S_S2 <- ggplot(out_SS2, aes(x = x, y = y)) +
  geom_segment(x = brms_2_CI$CI_low[2], xend = brms_2_CI$CI_high[2], y = 1, yend = 1, color = 'grey60', size = 1, alpha = 0.3)+
...
SIG2 <- ggplot(out_sigma2, aes(x = x, y = y)) +
  geom_segment(x = brms_2_CI$CI_low[3], xend = brms_2_CI$CI_high[3], y = 0.8, yend = 0.8, color = 'grey60', size = 1, alpha = 0.3)+
...
I_C3 <- ggplot(out_IC3, aes(x = x, y = y)) +
  geom_segment(x = brms_3_CI$CI_low[1], xend = brms_3_CI$CI_high[1], y = 0.6, yend = 0.6, color = 'grey60', size = 1, alpha = 0.3)+
...
S_D3 <- ggplot(out_SD3, aes(x = x, y = y)) +
  geom_segment(x = brms_3_CI$CI_low[2], xend = brms_3_CI$CI_high[2], y = 1, yend = 1, color = 'grey60', size = 1, alpha = 0.3)+
...
SIG3 <- ggplot(out_sigma3, aes(x = x, y = y)) +
  geom_segment(x = brms_3_CI$CI_low[3], y = 0.6, xend = brms_3_CI$CI_high[3], yend = 0.6, color = 'grey60', size = 1, alpha = 0.3)+
...
layout <- c(area(t=1,b=2,r=1,l=1), #brms 4 Int
            ...
            area(t=5, b=6.85,r=1,l=1) #LEGEND
            ) 

panel_plot <- I_C + I_C1 + I_C2 + I_C3 +  S_G + S_G1 + S_S + S_S2 + S_D + S_D3 + SIG + SIG1 + SIG2 + SIG3 + LEG + plot_layout(design = layout)
