...
brms_13_CI <- ci(brms_13, method = "HDI", component = 'all')

brms_13_CI$CI_low[1]


out <- estimate_density(brms_13_post, extend = T, select = 'b_Intercept')

#intercept - coastal
out_IC <- estimate_density(brms_13_post, extend = T, select = 'b_Intercept')
...
I_P
#slope - CFAR ~ GSH
out_SG <- estimate_density(brms_13_post, extend = T, select = 'b_Log10MeanGSH_centered')
