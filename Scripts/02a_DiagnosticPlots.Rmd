...
plot_11 <- ggplot(aes(x = LogCFAR_centered, y = LogMeanGSH_centered,  colour = LogDepthMedian_centered), data = GSH_df_full) 
...
plot_11 <- plot_11 + geom_point(alpha = 0.5, aes(size = LogMaxSize_centered)) +
...
#depths
plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_4)[1,1], slope = fixef(brms_4)[2,1], color = 'blue', size = 1.5)
...
plot_11 <- plot_11 +
  ...
  scale_y_continuous(name = "Mean GSH (% TL)", breaks = c(-2,-1,0,1,2), labels = y.ticks)

plot_11 <- plot_11 + annotation_logticks()

img1 <- readPNG(here("Data","Input","Mako_light.png"))
g1 <- rasterGrob(img1, interpolate = TRUE)

img2 <- readPNG(here("Data","Input","Apristurus_light.png"))
g2 <- rasterGrob(img2, interpolate = TRUE)

plot_12 <- plot_11 + annotate("segment", x = 2.64, xend = (2.64-0.25),
                       y = 2.8 , yend = (2.8-0.25), size = 0.75, colour = 'grey60', alpha = 0.5)

plot_12 <- plot_12 + annotate("segment", x = -1.63, xend = (-1.63-0.5),
                       y = -0.88 , yend = (-2), size = 0.75, colour = 'grey60', alpha = 0.5)

plot_12 <- plot_12 + annotation_custom(g1, xmin = 1.5, xmax = 2.74 , ymin = 1.5, ymax = 2.75) + annotation_custom(g2, xmin =-2.5 , xmax = (-1.25) , ymin = -3.25 , ymax = -1.55 )


ggsave(here('./Data/Output/Fig2_240321.png'), plot_12, height = 10, width = 16, units = 'cm')
...
depth.labels <- round(depth.labels)
size.labels <- round(size.labels)
cfar.labels <- round(cfar.labels)

cfar.labels


plot_11 <- ggplot(aes(x = LogMaxSize_centered, y = LogMeanGSH_centered,  colour = LogDepthMedian_centered), data = GSH_df_full) 
...
plot_11 <- plot_11 + geom_point(alpha = 0.5, aes(size = LogCFAR_centered)) +
  scale_size(guide = "legend", breaks = c(-2, 0, 2), labels = cfar.labels, name = "CFAR") +
  scale_color_gradient(low = '#D1D5FF', high = '#070469', name = "Median Depth (m)", breaks = c(-2, -1, 0, 1), labels = depth.labels)+
  theme_bw()+
       ylab("Log10 GSH (proportion of TL)")+
       xlab("Log10 Maximum size (cm TL)") +
  guides(color = guide_colourbar(reverse = TRUE))

#depths
plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_4)[1,1], slope = fixef(brms_4)[3,1], color = '#7570b3', size = 1.5)
plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_4)[1,1] + sh.line.int, slope = fixef(brms_4)[2,1], color = '#7570b3', size = 1.5)
plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_4)[1,1] + dp.line.int, slope = fixef(brms_4)[2,1], color = '#070469', size = 1.5) 
...
x.ticks <- rep(NA, 7)
for(i in -2:4){
x.ticks[i+3] <- exp((sd(GSH_df_full$LogMaxSize)*i) + mean(GSH_df_full$LogMaxSize))
}
...
plot_11 <- plot_11 +
  scale_x_continuous(name = "Maximum size (cm TL)", breaks = c(-2,-1,0,1,2, 3, 4), labels = as.character(x.ticks)) +
  scale_y_continuous(name = "Mean GSH (% TL)", breaks = c(-2,-1,0,1,2), labels = y.ticks)
...
plot_12 <- plot_12 + annotation_custom(g1, xmin = 1.5, xmax = 2.64 , ymin = 1.5, ymax = 2.55) + annotation_custom(g2, xmin =-2.5 , xmax = (-1.5) , ymin = -2.94 , ymax = -1.55 )


ggsave(here('./Data/Output/Fig2_plot3_for_presentation.png'), plot_11, height = 10, width = 16, units = 'cm')
```
...
plot_11 <- ggplot(aes(x = LogDepthMedian_centered, y = LogMeanGSH_centered,  colour = LogDepthMedian_centered), data = GSH_df_full) 
...
#depths
plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_4)[1,1], slope = fixef(brms_4)[4,1], color = '#7570b3', size = 1.5)
plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_4)[1,1] + sh.line.int, slope = fixef(brms_4)[2,1], color = '#7570b3', size = 1.5)
plot_11 <- plot_11 + geom_abline(intercept = fixef(brms_4)[1,1] + dp.line.int, slope = fixef(brms_4)[2,1], color = '#070469', size = 1.5) 
...
plot_11 <- plot_11 +
  scale_x_continuous(name = "Median depth (m)", breaks = c(-2,-1,0,1), labels = as.character(x.ticks)) +
  scale_y_continuous(name = "Mean GSH (% TL)", breaks = c(-2,-1,0,1,2), labels = y.ticks)
...
ggsave(here('./Data/Output/Fig2_plot4_for_presentation.png'), plot_11, height = 10, width = 16, units = 'cm')
```
...
I_C <- ggplot(out_IC, aes(x = x, y = y)) +
  ...
  geom_vline(xintercept = 0, lty = 1, size = 1, color = 'grey70', alpha = 0.5) +
  xlim(-1, 1) +
  ylim(0,2) +
    annotate("text", x = -0.98, y = 1.25, label = "(d) Intercept") +
...
S_G <- ggplot(out_SG, aes(x = x, y = y)) +
  ...
  geom_vline(xintercept = 0, lty = 1, color = 'grey70', alpha = 0.5) +
  xlim(-1, 1) +
  ylim(0,2) +
    annotate("text", x = -1, y = 1.25, label = "(a) Activity") +
...
S_S <- ggplot(out_SS, aes(x = x, y = y)) +
  ...
  xlim(-1, 1) +
  ylim(0,2) +
    annotate("text", x = -0.87, y = 1.25, label = "(b) Maximum body size") +
  theme(legend.position = "none",
        panel.grid = element_blank(),
        axis.title = element_blank(),
        axis.text = element_blank(),
...
S_D <- ggplot(out_SD, aes(x = x, y = y)) +
 geom_segment(x = brms_4_CI$CI_low[4], xend = brms_4_CI$CI_high[4], y = 1.25, yend = 1.25, color = 'black', size = 0.5, alpha = 0.3) +
  ...
  xlim(-1, 1) +
  ylim(0,2) +
  annotate("text", x = -0.93, y = 1.25, label = "(c) Median depth") +
 theme(legend.position = "none",
        panel.grid = element_blank(),
        axis.title = element_blank(),
        axis.text = element_blank(),
...
SIG <- ggplot(out_sigma, aes(x = x, y = y)) +
  ...
  geom_point(x = mean(brms_4_post$sigma), y = 1.25, color = 'black', size = 2) +
    geom_vline(xintercept = 0, lty = 1, color = 'grey70', alpha = 0.5) +
  scale_x_continuous(name = "Coefficient estimates", limits = c(-1, 1), breaks = c(-1, 0, 1)) +
  ylim(0,2) +
  annotate("text", x = -1, y = 1.25, label = "(e) Sigma") +
  theme(legend.position = "none",
        panel.grid = element_blank(),
        axis.title.y = element_blank(),
...
S_G1 <- ggplot(out_SG1, aes(x = x, y = y)) +
  ...
  annotate("text", x = 0.65, y = 1, label = "Activity model", size = 3, color = 'grey60') +
  xlim(-1, 1) +
  ylim(0,2) +
  theme(legend.position = "none",
        panel.grid = element_blank(),
...
S_S2 <- ggplot(out_SS2, aes(x = x, y = y)) +
  ...
  annotate("text", x = 0.65, y = 1, label = "Maximum size model", size = 3, color = 'grey60') +
  xlim(-1, 1) +
  ylim(0,2) +
  theme(legend.position = "none",
        panel.grid = element_blank(),
...
S_D3 <- ggplot(out_SD3, aes(x = x, y = y)) +
  ...
  annotate("text", x = -0.5, y = 1, label = "Median depth model", size = 3, color = 'grey60') +
  xlim(-1, 1) +
  ylim(0,2) +
  theme(legend.position = "none",
        panel.grid = element_blank(),
...
panel_plot2 <- plot_11b + panel_plot + plot_layout(widths = c(2,1))
...
### Supp fig size ~ depth
```{r}
x_int <- mean(GSH_df_full$LogDepthMedian, na.rm = TRUE)
y_int <- mean(GSH_df_full$LogMaxSize, na.rm = TRUE)


Size.depth <- ggplot(data = GSH_df_full, aes(x = LogDepthMedian, y = LogMaxSize)) +
  geom_point() +
  geom_smooth(method = 'lm', formula = 'y ~ x') +
  geom_hline(yintercept = y_int, linetype = "dashed", color = 'grey50', size = 1) +
  geom_vline(xintercept = x_int, linetype = "dashed", color = 'grey50', size = 1) +
  annotate(geom = 'text', label = '90 m', x = x_int, y = 2.2) +
  annotate(geom = 'text', label = '89 cm TL', x = 7.2, y = (y_int+0.2)) +
  theme_bw()
...
### supp figure GSH ~ depth
```{r}

GSH.depth <- ggplot(data = GSH_df_full, aes(x = LogDepthMedian, y = LogMeanGSH)) +
  geom_vline(xintercept = 4.499, linetype = "dashed", color = 'grey50', size = 1) +
  geom_hline(yintercept = -3.507, linetype = 'dashed', color = 'grey50', size = 1) +
  annotate(geom = 'text', label = '90 m', x = 4.48, y = -4.7) +
  annotate(geom = 'text', label = '3% TL', x = 7.56, y = -3.44) +
  geom_point() +
  geom_smooth(method = 'lm', formula = 'y ~ x') +
  theme_bw()
...
```{r}
ggsave(here('./Data/Output/Supp_GSH_depth.png'), GSH.depth, device = 'png', height = 6, width = 8, units = 'in')
```



### FIG for size and activity
```{r}
Size.activity <- ggplot(data = GSH_df_full, aes(x = LogDepthMedian, y = LogCFAR)) +
  geom_vline(xintercept = mean(GSH_df_full$LogDepthMedian, na.rm = T), linetype = "dashed", color = 'grey50', size = 1) +
  geom_hline(yintercept = mean(GSH_df_full$LogCFAR), linetype = 'dashed', color = 'grey50', size = 1) +
  annotate(geom = 'text', label = '90 m', x = 4.8, y = -1.9) +
  annotate(geom = 'text', label = '1.04', x = 7.56, y = 0.23) +
  geom_point() +
  geom_smooth(method = 'lm', formula = 'y ~ x')
