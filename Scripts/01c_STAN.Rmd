...
fit6 <- stan(file = './StanModel3.stan', data = stan_data6, warmup = 500, iter = 1000, chains = 4, cores = 5, thin = 1,
...
fit7 <- stan(file = './StanModel3.stan', data = stan_data7, warmup = 500, iter = 1000, chains = 4, cores = 4, thin = 1,
             pars = c('beta','sigma','lambda', 'log_lik'))
```
...
fit8 <- stan(file = './StanModel3.stan', data = stan_data8, warmup = 500, iter = 1000, chains = 4, cores = 4, thin = 1,
             pars = c('beta','sigma','lambda', 'log_lik'))
```
...
fit9 <- stan(file = './StanModel3.stan', data = stan_data9, warmup = 500, iter = 1000, chains = 4, cores = 4, thin = 1,
             pars = c('beta','sigma','lambda', 'log_lik'))
```
...
fit10 <- stan(file = './StanModel3.stan', data = stan_data10, warmup = 500, iter = 1000, chains = 4, cores = 4, thin = 1,
             pars = c('beta','sigma','lambda', 'log_lik'))
```
...
fit11 <- stan(file = './StanModel3.stan', data = stan_data11, warmup = 500, iter = 2000, chains = 4, cores = 4, thin = 10,
             pars = c('beta','sigma','lambda', 'log_lik'))
```

```{r}
save(fit11, file = here("./Data/Output/STANMod10_v1.rds"))
