...
plot(Log10CFAR ~ Log10MeanGSH_centered, data = GSH_df_pgls, pch = 20)
#coastal (a = 1, b = 2)
abline(a = coef(pglsMod7)[1], 
       b = coef(pglsMod7)[2], 
       col = 'black', lw = 2)
#deepwater (a = 1 + 3, b = 2 + 5)
abline(a = coef(pglsMod7)[1] + coef(pglsMod7)[3], 
       b = coef(pglsMod7)[2], 
       col = 'blue', lw =2)
#pelagic (a = 1 + 4, b = 2 + 6)       
abline(a = (coef(pglsMod7)[1] + coef(pglsMod7)[4]), 
       b = (coef(pglsMod7)[2]), 
       col = 'green', lw =2)
#max size
abline(a = (coef(pglsMod7)[1] + coef(pglsMod7)[5]), 
       b = (coef(pglsMod7)[2]), 
       col = 'red', lw =2)
```
