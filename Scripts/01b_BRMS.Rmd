...
exp(mean(GSH_df_full$LogCFAR, na.rm = T) + sd(GSH_df_full$LogCFAR, na.rm = T)) - exp(mean(GSH_df_full$LogCFAR, na.rm = TRUE))

#BCI - -0.1 , 0.98
round((exp((sd(GSH_df_full$LogMeanGSH, na.rm = T)*0.37) + mean(GSH_df_full$LogMeanGSH, na.rm = T))*100),2)
round((exp((sd(GSH_df_full$LogMeanGSH, na.rm = T)*0.98) + mean(GSH_df_full$LogMeanGSH, na.rm = T))*100),2)
...
```{r}
#size of 1SD
round(sd(GSH_df_full$LogCFAR, na.rm = T),2)
```
...
round((exp((sd(GSH_df_full$LogMeanGSH, na.rm = T)*0.38) + mean(GSH_df_full$LogMeanGSH, na.rm = T)) * 100),2)
...
#BCI - -0.16 , 0.74
round((exp((sd(GSH_df_full$LogMeanGSH, na.rm = T)*-0.16) + mean(GSH_df_full$LogMeanGSH, na.rm = T)) * 100),2)
round((exp((sd(GSH_df_full$LogMeanGSH, na.rm = T)*0.74) + mean(GSH_df_full$LogMeanGSH, na.rm = T)) * 100),2)
