...
```
```{r}
fit1_summary <- summary(fit1, pars = c("alpha", "beta","sigma"), probs = c(0.05, 0.95))$summary
print(fit1_summary)
```
...
```{r}
fit2_summary <- summary(fit2, pars = c("beta[1]", "beta[2]","beta[3]","beta[4]","sigma"), probs = c(0.05, 0.95))$summary
print(fit2_summary)
```
...
```{r}
fit3_summary <- summary(fit3, pars = c("beta[1]", "beta[2]","sigma"), probs = c(0.05, 0.95))$summary
print(fit3_summary)
```
